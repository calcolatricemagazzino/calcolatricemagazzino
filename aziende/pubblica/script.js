...
var prezzi = [
  ...
  { nome: "Caffe'/C. Macchiato", prezzo: 80 },
  ...
  { nome: "Cornetti", prezzo: 128 },
  { nome: "Gianduiotti", prezzo: 320 },
...
function calcola() {
  ...
  oggetti[19] = parseInt(document.getElementById("cornetti").value);
  oggetti[20] = parseInt(document.getElementById("gianduiotti").value);
  oggetti[21] = parseInt(document.getElementById("kebab").value);
