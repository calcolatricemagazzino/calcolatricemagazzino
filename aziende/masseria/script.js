...
var prezzi = [
  ...
  { nome: "Donut", prezzo: 160 },
  { nome: "Hamburger Della Bestia", prezzo: 160 },
  { nome: "Hot Dog", prezzo: 40 },
  { nome: "Sushi", prezzo: 160 },
  { nome: "Hamburger", prezzo: 160 },
  { nome: "Pane", prezzo: 160 },
  { nome: "Caffè/C. Macchiato", prezzo: 80 },
...
function calcola() {
  ...
  oggetti[0] = parseInt(document.getElementById("zuppafunghi").value);
  oggetti[1] = parseInt(document.getElementById("salmone").value);
  oggetti[2] = parseInt(document.getElementById("oreo").value);
  oggetti[3] = parseInt(document.getElementById("donut").value);
  oggetti[4] = parseInt(document.getElementById("hamburgerdellabestia").value);
  oggetti[5] = parseInt(document.getElementById("hotdog").value);
  oggetti[6] = parseInt(document.getElementById("sushi").value);
  oggetti[7] = parseInt(document.getElementById("hamburger").value);
  oggetti[8] = parseInt(document.getElementById("pane").value);
  oggetti[9] = parseInt(document.getElementById("caffe").value);
  oggetti[10] = parseInt(document.getElementById("pepsi").value);
  oggetti[11] = parseInt(document.getElementById("pringles").value);
  oggetti[12] = parseInt(document.getElementById("milkshake").value);
  oggetti[13] = parseInt(document.getElementById("gin").value);
  oggetti[14] = parseInt(document.getElementById("whisky").value);
  oggetti[15] = parseInt(document.getElementById("vodka").value);
  oggetti[16] = parseInt(document.getElementById("birra").value);
  oggetti[17] = parseInt(document.getElementById("codeina").value);
  oggetti[18] = parseInt(document.getElementById("blueangel").value);
  oggetti[19] = parseInt(document.getElementById("tacos").value);
  oggetti[20] = parseInt(document.getElementById("succhi").value);
  oggetti[21] = parseInt(document.getElementById("gelati").value);
  oggetti[22] = parseInt(document.getElementById("ghiaccioli").value);
  oggetti[23] = parseInt(document.getElementById("mojito").value);
