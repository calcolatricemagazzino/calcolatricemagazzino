function calcola() {
  ...
  stacksprite = document.getElementById("sprite").value;
  stackfanta = document.getElementById("fanta").value;
  stackmonster = document.getElementById("monster").value;
  stackschweppes = document.getElementById("schweppes").value;
  stacklongisland = document.getElementById("longisland").value;
  stackcrodino = document.getElementById("crodino").value;
  ...
  totale =
    ...
    stacksprite * sprite +
    stackfanta * fanta +
    stackmonster * monster +
    stackschweppes * schweppes +
    stacklongisland * longisland +
    stackcrodino * crodino;
  ...
  if (stacksprite == 0) {
    ...
    spritetext = "- " + stacksprite + "x64 Sprite" + "<br>";
  }
  if (stackfanta == 0) {
    fantatext = "";
  } else {
    fantatext = "- " + stackfanta + "x64 Fanta" + "<br>";
  }
  if (stackmonster == 0) {
    monstertext = "";
  } else {
    monstertext = "- " + stackmonster + "x64 Monster" + "<br>";
  }
  if (stackschweppes == 0) {
    schweppestext = "";
  } else {
    schweppestext = "- " + stackschweppes + "x64 Schweppes" + "<br>";
  }
  if (stacklongisland == 0) {
    longislandtext = "";
  } else {
    longislandtext = "- " + stacklongisland + "x64 Long Island" + "<br>";
  }
  if (stackcrodino == 0) {
    crodinotext = "";
  } else {
    crodinotext = "- " + stackcrodino + "x64 Crodino" + "<br>";
  }
