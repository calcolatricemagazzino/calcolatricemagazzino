function calcola() {
  ...
  stackdonut = document.getElementById("donut").value;
  stackhamburgerdellabestia = document.getElementById(
    "hamburgerdellabestia"
  ).value;
  ...
  totale =
    ...
    stackoreo * oreo +
    stackdonut * donut +
    stackhamburgerdellabestia * hamburgerdellabestia;
  ...
  if (stackdonut == 0) {
    ...
    donuttext = "- " + stackdonut + "x64 Donut" + "<br>";
  }
  if (stackhamburgerdellabestia == 0) {
    hamburgerdellabestiatext = "";
  } else {
    hamburgerdellabestiatext =
      "- " + stackhamburgerdellabestia + "x64 Hamburger Della Bestia" + "<br>";
  }
