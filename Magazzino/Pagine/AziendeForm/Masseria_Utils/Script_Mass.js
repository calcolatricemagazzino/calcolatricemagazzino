...
var prezzi = [
    ...
    { nome: "Hamburger_della_bestia", prezzo: 160}
];
...
function calcolaFattura() {
    ...
    Compere[23] = parseInt(document.getElementById("Donut").value);
    Compere[24] = parseInt(document.getElementById("Hamburger_della_bestia").value);
