...
var prezzi = [
    ...
    { nome: "Amaro_Lucano", prezzo: 700 },
    { nome: "Cuba_Libre", prezzo: 700 },
    { nome: "Long_Island", prezzo: 700 },
...
function calcolaFattura() {
    ...
    Compere[20] = parseInt(document.getElementById("Sprite").value);
    Compere[21] = parseInt(document.getElementById("Fanta").value);
    Compere[22] = parseInt(document.getElementById("Monster").value);
    Compere[23] = parseInt(document.getElementById("Schweppes").value);
    Compere[24] = parseInt(document.getElementById("Spritz").value);
    Compere[25] = parseInt(document.getElementById("Amaro_Lucano").value);
    Compere[26] = parseInt(document.getElementById("Cuba_Libre").value);
    Compere[27] = parseInt(document.getElementById("Long_Island").value);
    Compere[28] = parseInt(document.getElementById("Crodino").value);
