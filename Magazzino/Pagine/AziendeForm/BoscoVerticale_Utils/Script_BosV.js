...
var prezzi = [
    ...
    { nome: "Zuppa_di_funghi", prezzo: 560 },
    { nome: "Salmone", prezzo: 560 },
    { nome: "Ovetto_kinder", prezzo: 320 },
    { nome: "Champagne", prezzo: 700 },
    { nome: "Dom_Perignom", prezzo: 700 },
    { nome: "Don_Giovanni", prezzo: 700 },
    { nome: "Jack_Spisporks", prezzo: 700 },
    { nome: "Martini", prezzo: 700 },
    { nome: "Moet", prezzo: 700 },
    { nome: "Prosecco", prezzo: 700 },
    { nome: "Rosè_Nero_Avola", prezzo: 700 }
];
...
function calcolaFattura() {
    ...
    Compere[23] = parseInt(document.getElementById("Ovetto_kinder").value);
    Compere[24] = parseInt(document.getElementById("Champagne").value);
    Compere[25] = parseInt(document.getElementById("Dom_Perignom").value);
    Compere[26] = parseInt(document.getElementById("Don_Giovanni").value);
    Compere[27] = parseInt(document.getElementById("Jack_Spisporks").value);
    Compere[28] = parseInt(document.getElementById("Martini").value);
    Compere[29] = parseInt(document.getElementById("Moet").value);
    Compere[30] = parseInt(document.getElementById("Prosecco").value);
    Compere[31] = parseInt(document.getElementById("Rosè_Nero_Avola").value);
