...
var prezzi = [
    { nome: "Stendardo_semplice", prezzo: 260, val: 8 },
    { nome: "Stendardo_modificato", prezzo: 415, val: 8 },
    { nome: "Fuochi_artificio", prezzo: 400, val: 64 }
  ];
...
function calcolaFattura() {
    ...
    Compere[0] = parseInt(document.getElementById("Stendardo_semplice").value);
    Compere[1] = parseInt(document.getElementById("Stendardo_modificato").value);
    Compere[2] = parseInt(document.getElementById("Fuochi_artificio").value);
